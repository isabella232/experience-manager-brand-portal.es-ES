...
* Independientemente de las funciones de usuario y los privilegios, cuando los usuarios inician sesión en Brand Portal, verán todas las carpetas públicas y las carpetas que se comparten directamente con ellos o con un grupo al que pertenecen. Las carpetas privadas o las carpetas compartidas con otros usuarios no son visibles para todos los usuarios.

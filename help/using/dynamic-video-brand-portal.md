...
>[!NOTE]
>
>Los vídeos dinámicos no son compatibles con los inquilinos de Brand Portal configurados con AEM Author que se ejecutan en el modo de ejecución de **[!UICONTROL Scene7 Connect]** .
...
2. En el panel Herramientas administrativas, seleccione el mosaico Configuración **[!UICONTROL de medios]** dinámicos.<br />
